"""Server-side trigger-family probe bank for TRACEGuard.
...
class TriggerFamilyProbeBank:
    ...
    def sample(
        ...
        *,
        ...
        if len(reference_dataset) == 0:
            raise ValueError("TRACEGuard reference dataset is empty")
    ...
    def _apply_family(
        ...
        *,
        ...
        raise ValueError(f"Unsupported TRACEGuard probe family: {family}")
